...
description: Conducts multi-step web research with source synthesis and citations. Use when a question needs authoritative, cited answers drawn from multiple primary sources rather than a single lookup.
model: sonnet
