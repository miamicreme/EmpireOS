...
const tools = [recorderTranscribeTool as unknown as AnyToolDefinition] as const;
...
export function listTools(): ReadonlyArray<Pick<AnyToolDefinition, 'id' | 'version' | 'moduleId' | 'description' | 'riskLevel' | 'sideEffect' | 'approvalPolicy'>> {
