...
/**
 * POST /api/ai/input/analyze
 *
 * Owner-only universal input analysis. This route normalizes submitted text,
 * document, spreadsheet, image, camera, video-frame, or transcript content into
 * compact agent artifacts without creating a second AI runtime.
 */
